          ...
          >
            <div className="watchlist-row-leading">
              ...
              <div className="mini-symbol">
                <span className="mini-symbol-icon">{stock.symbol.slice(0, 1)}</span>
                <div>
                  <strong>{stock.symbol}</strong>
                  {stock.symbol === selectedSymbol && formatMarketDataTimestamp(selectedDataFetchedAt) ? (
                    <small>Daten {formatMarketDataTimestamp(selectedDataFetchedAt)}</small>
                  ) : null}
                </div>
              </div>
            </div>
